---
title: "Configure Nginx as PharmaVault Reverse Proxy"
sidebarTitle: "Nginx"
description: "Set up Nginx to terminate SSL, redirect HTTP to HTTPS with a 301, and forward WebSocket upgrade headers required by Blazor Server's SignalR connection."
---
