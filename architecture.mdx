---
title: "PharmaVault Architecture: Clean N-Tier Design"
...
<CardGroup cols={3}>
  <Card title="PharmaVault.Core" icon="circle-dot">
    ...
    *Key dependency:* `BCrypt.Net-Next` for password hashing.
  </Card>
  ...
  <Card title="PharmaVault.Web" icon="globe">
    ...
    *Key dependencies:* `BCrypt.Net-Next`, `Blazor-ApexCharts 6.1.0`.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Status code pages">
    `UseStatusCodePagesWithReExecute("/not-found")` serves a custom 404 page for all unmatched routes.
  </Step>
