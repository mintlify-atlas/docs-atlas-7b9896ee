...
description: "Full reference for PharmaVault's five PostgreSQL tables — users, inventory, medicine_catalog, system_responses, and error_logs — including keys and FK relationships."
---
